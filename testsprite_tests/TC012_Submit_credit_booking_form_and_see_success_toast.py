...
async def run_test():
    ...
    try:
        ...
        # -> Type the test credentials into the username and password fields and click Login (fill username with example@gmail.com and password with password123).
        ...
        # -> Click the Login button (index 6) to attempt sign-in again, then wait for the page to update and check for navigation to /booking.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/main/div/div/div/form/div[4]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
