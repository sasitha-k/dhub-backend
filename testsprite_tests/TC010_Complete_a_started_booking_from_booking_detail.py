...
async def run_test():
    ...
    try:
        ...
        # -> Fill username and password fields and submit the login form by clicking the Login button.
        ...
        # -> Click the Login button (index 6) again to retry sign-in, then wait for the SPA to finish redirecting and verify the URL contains '/booking'.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/main/div/div/div/form/div[4]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
