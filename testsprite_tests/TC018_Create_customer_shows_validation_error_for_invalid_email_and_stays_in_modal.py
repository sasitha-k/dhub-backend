...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email/username and password fields with test credentials and click the Login button.
        ...
        # -> Click the Login button to (re-)submit the credentials and attempt to reach the authenticated area (click element index 6).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/main/div/div/div/form/div[4]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        ...
        assert await frame.locator("xpath=//*[contains(., 'Create customer modal')]").nth(0).is_visible(), "Expected 'Create customer modal' to be visible"
